...
def _episode_close_edge(value: dict[str, Any]) -> dict[str, Any]:
    result = _facade()._episode_write_edge(value)
...
def episode_begin(
    ...
    *,
    ...
    return _facade()._episode_write_edge(
        dict(
            _runtime().run_storage_service_operation(
                "episode_begin",
                str(runtime_dir),
                _facade()._episode_write_options(
                    {
...
def episode_end(
    ...
    *,
    ...
    return _facade()._episode_close_edge(
        dict(
            _runtime().run_storage_service_operation(
                "episode_end",
                str(runtime_dir),
...
def episode_recover(
    ...
    *,
    ...
    result["recovered"] = [
        _facade()._episode_close_edge(dict(item))
    ...
    *,
    ...
    result = dict(
        _runtime().run_storage_service_operation(
            ...
            str(runtime_dir),
            _facade()._episode_write_options(options, write_retry),
        )
    )
