...
def resolve_qualified_work_profile(
    runtime_dir: str | Path, *, required: Literal[True] = True
) -> dict[str, str]: ...


@overload
def resolve_qualified_work_profile(
    runtime_dir: str | Path, *, required: Literal[False]
) -> dict[str, str] | None: ...


def resolve_qualified_work_profile(
    runtime_dir: str | Path, *, required: bool = True
) -> dict[str, str] | None:
    ...
    if state is None:
        return None
    source = _retained_profile_source(runtime_dir, state)
